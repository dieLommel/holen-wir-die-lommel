...
export default function AboutStory() {
  return (
    <section id="about" className="relative bg-canvas px-[5%] py-32 lg:py-48 overflow-hidden z-10 border-b border-slate/10">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-24 xl:gap-32 items-center">
          ...
          <motion.div 
            ...
            className="w-full order-1 lg:order-2 mb-16 lg:mb-0"
          >
